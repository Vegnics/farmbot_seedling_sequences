...
for coordinate_location in PD.plant_db.coordinate_locations:
   if coordinate_location[2] > 8:
        ...
        CeleryPy.move_absolute((coordinate_location[0],coordinate_location[1],-265),(0,0,0),80)
        CeleryPy.wait(500)
        CeleryPy.write_pin(number=4, value=1, mode=0)
        CeleryPy.wait(500)
        CeleryPy.move_absolute((coordinate_location[0],coordinate_location[1],-215),(0,0,0),80)
        CeleryPy.wait(1500)
        CeleryPy.move_absolute((700,500,-215),(0,0,0),150)
        CeleryPy.wait(500)
        CeleryPy.write_pin(number=4, value=0, mode=0)
